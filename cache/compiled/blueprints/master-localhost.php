...
return [
    ...
    'timestamp' => 1451595670,
    'checksum' => 'fd702d881de58198694b0b832348dc49',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.login.user_registration.options.validate_password' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_LOGIN.VALIDATE_PASSWORD',
                'help' => 'PLUGIN_LOGIN.VALIDATE_PASSWORD_HELP',
                'highlight' => 1,
                'options' => [
                    1 => 'PLUGIN_ADMIN.YES',
                    0 => 'PLUGIN_ADMIN.NO'
                ...
                'name' => 'plugins.login.user_registration.options.validate_password'
            ],
                ...
                'login' => [
                    ...
                    'user_registration' => [
                        ...
                        'options' => [
                            ...
                            'validate_password' => 'plugins.login.user_registration.options.validate_password',
